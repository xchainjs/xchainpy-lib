...
class Client(BaseXChainClient, IFantomClient):
    wss_provider = ftmscan_token = ""
    ...
    def __init__(self, params: FantomClientParams):
        BaseXChainClient.__init__(self, Chain.Fantom, params)
        ...
        self.set_ftmscan_token(params.ftmscan_token)
    ...
    def set_ftmscan_token(self, ftmscan_token: str):
        self.ftmscan_token = ftmscan_token
    ...
    def get_explorer_url(self) -> str:
        ...
        """
        return 'https://testnet.ftmscan.com' if self.network == 'testnet' else 'https://ftmscan.com'
    ...
    async def get_abi(self, contract_address):
        ...
        if os.path.exists(path):
            ...
            if not self.ftmscan_token:
                raise Exception("undefined ftm api token")
            if self.network == 'mainnet':
                url = f'https://api.ftmscan.com/api?module=contract&action=getabi&address={contract_address}&apikey={self.ftmscan_token}'
            else:
                url = f'https://api-testnet.ftmscan.com/api?module=contract&action=getabi&address={contract_address}&apikey={self.ftmscan_token}'
    ...
    async def get_contract(self, contract_address, erc20=True):
        ...
        Args:
            contract_address: fantom contract address
    ...
    async def get_balance(self, asset=None, address=None):
        ...
        Args:
            asset: asset object, if None, return balance of fantom. (optional)
    ...
    async def write_contract(self, contract_address, func_to_call, *args, erc20=True, gas_limit=1000000, gas_price=None, nonce=None, ftm_to_be_sent=0):
        ...
        Args:
            ...
            **kwargs: arguments for func_to_call
            ...
            ftm_to_be_sent: in case fantom needed to be sent
        ...
        if ftm_to_be_sent != 0:
            tx = {
                'nonce': nonce,
                'value': self.w3.toWei(ftm_to_be_sent, 'ether'),
                'gas': gas_limit,
                'gasPrice': gas_price,
            }
        else:
