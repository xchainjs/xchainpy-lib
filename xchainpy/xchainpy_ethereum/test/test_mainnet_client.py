...
class TestClient:
    ...
    def test_get_abi(self, test_init):
        ...
        assert str(self.client.get_abi(self.sushi_contract_address)) == str(self.sushi_abi)
    ...
    def test_get_contract(self, test_init):
        sushi_contract = self.client.get_contract(self.sushi_contract_address, erc20=False)
    ...
    def test_read_contract(self, test_init):
        ...
        assert self.client.read_contract(self.sushi_contract_address, "factory", erc20=False) == "0xC0AEe478e3658e2610c5F7A4A2E1777cE9e4f2Ac"
