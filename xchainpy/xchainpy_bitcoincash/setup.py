...
setup(
    ...
    install_requires=['mnemonic>=0.18', 'bitcash>=0.6.1', 'cashaddress_regtest>=1.1.0', 'cashaddress>=1.0.6', 'http3>=0.6.7', 'xchainpy_client>=0.1.5', 'xchainpy_crypto>=0.1.7', 'xchainpy_util>=0.1.7', 'bip_utils>=1.11.1'],
    classifiers=[
